...
public class Url extends TableImpl<UrlRecord> {
     ...
     */
    public final TableField<UrlRecord, Long> ID =
     ...
     */
    public final TableField<UrlRecord, OffsetDateTime> LAST_CHECK =
        createField(DSL.name("LAST_CHECK"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    /**
     * The column <code>URL.LAST_CHANGE</code>.
     */
    public final TableField<UrlRecord, OffsetDateTime> LAST_CHANGE =
        createField(DSL.name("LAST_CHANGE"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
