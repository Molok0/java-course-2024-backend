...
import edu.java.configuration.kafka.serdes.MessageDeserializer;
...
public class ProtobufMessagesKafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String,
        MessageOuterClass.Message> protobufMessageKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, MessageOuterClass.Message> factory =
